...
- Prompt artifact: docs/reviews/PR_FIX_PROMPT_20260106-0716_pr-21_audio-session-gating.md
- Review artifact (most recent if present): docs/reviews/PR_REVIEW_20260106-0716_pr-21_audio-session-gating.md
- Reply scratchpad (optional): docs/reviews/PR_REPLY_20260106-0716_pr-21_audio-session-gating.md
...
## What to do
1) Read `docs/reviews/PR_REVIEW_20260106-0716_pr-21_audio-session-gating.md` if it exists (or the review content I paste in chat) and extract:
